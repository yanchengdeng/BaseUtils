...
public class ChannelUtil {
	...
	private static void saveChannelInSP(Context context, String channel){
		SPUtils.getInstance().put( PREF_KEY_CHANNEL, channel);
		SPUtils.getInstance().getInt( PREF_KEY_CHANNEL_VERSION, getVersionCode(context));
	}
	...
	private static String getChannelFromSP(Context context){
		...
		int versionCodeSaved = SPUtils.getInstance().getInt( PREF_KEY_CHANNEL_VERSION, -1);
		...
		return SPUtils.getInstance().getString( PREF_KEY_CHANNEL, "");
	}
